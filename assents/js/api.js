/* async function buscarDadosPerfil = Define uma função assíncrona chamada */
async function buscarDadosPerfil() {
    const url = 'https://raw.githubusercontent.com/GabrielSilvaG/Portfolio-/master/data/profile.json?token=GHSAT0AAAAAACOYBXIJ7L47CKJVKDGTGJXSZQDG55Q'; /*const url = Declara uma constante chamada url que contém o endereço da API de onde os dados serão buscados.*/
