async function buscarDadosPerfil() { /* async function buscarDadosPerfil = Define uma função assíncrona chamada */
    ...
    const url =`https://raw.githubusercontent.com/GabrielSilvaG/Portfolio-/master/data/profile.json?token=GHSAT0AAAAAACOYBXIJKYNLHEE7P64UMJ6EZQDGFDA`; /*const url = Declara uma constante chamada url que contém o endereço da API de onde os dados serão buscados.*/
